...
def evaluate_reconstruction(
    ground_truth: Tensor, reconstructed: Tensor, feature_info: Dict, return_per_feature: bool = True
) -> Dict:
    ...
    for _, feature in enumerate(cat_feats):
        # Find categories
